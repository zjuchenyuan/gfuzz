...
cd bazel-bin/gopath
export GOPATH=`pwd`
cp runsc/*.go src/gvisor.dev/gvisor/runsc/
cp go* src/gvisor.dev/gvisor/
...
grep InitCoverageData src/gvisor.dev/gvisor/pkg/coverage/coverage.go ||cp /home/ubt/gvisor.latest/coverage.go src/gvisor.dev/gvisor/pkg/coverage/coverage.go
#GO111MODULE=off go build gvisor.dev/gvisor/runsc
GO111MODULE=off /g/go-callvis -file /g/gvisor_bin/$COMMIT/edge.txt gvisor.dev/gvisor/runsc
cd ..
mkdir /gvisor_build/$COMMIT/
